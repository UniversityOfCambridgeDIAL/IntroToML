...
<img src="new_notebook.png" alt="Python 3.6 for new notebook" style="width: 200px;"/>

![Python 3.6 for new notebook](new_notebook.png?raw=true "Python 3.6 for new notebook" =250x)
